...
import { RideNavigationModal } from "./ride-navigation-modal";
            ...
            <div className="grid grid-cols-2 gap-3">
              ...
              <div className="flex items-center gap-2 p-2 bg-muted/50 rounded-md">
                ...
                <div>
                  ...
                  <p className="text-sm font-medium">
                    {tripDistance ? `${tripDistance} km` : "Calculating..."}
                  </p>
                </div>
              </div>
            </div>
      ...
      <RideNavigationModal
        ...
        request={{
          ...
          pickup_location: {
            ...
            latitude: request.pickup_location.latitude || 0,
            longitude: request.pickup_location.longitude || 0
          },
          destination: {
            ...request.destination,
          ...
          distance_to_pickup: request.distance_to_pickup || { value: 0, unit: 'km' }
        }}
      />
    </>
  );
